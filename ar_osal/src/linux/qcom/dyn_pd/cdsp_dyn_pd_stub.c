...
#ifndef _AUDIO_PD_CDSP_SLIM_H
#define _AUDIO_PD_CDSP_SLIM_H
#include <stdint.h>
...
static const char strings[25] = "deinit\0close\0open\0uri\0h\0";
static const uint16_t methodStrings[7] = {13,18,22,7,22,0,2};
static const uint16_t methodStringsArrays[4] = {0,3,6,5};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(audio_pd_cdsp_slim) = {4,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
#endif //_AUDIO_PD_CDSP_SLIM_H


#ifdef __cplusplus
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(audio_pd_cdsp_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(audio_pd_cdsp_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT int __QAIC_STUB(audio_pd_cdsp_init)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method(_handle, _mid);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(audio_pd_cdsp_deinit)(remote_handle64 _handle) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method(_handle, _mid);
}
#ifdef __cplusplus
