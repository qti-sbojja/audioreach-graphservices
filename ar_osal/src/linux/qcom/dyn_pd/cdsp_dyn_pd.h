...
#endif
/**
*  functions remoted from the avs during init to the dsp
*/
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(audio_pd_cdsp_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/**
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(audio_pd_cdsp_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(audio_pd_cdsp_init)(remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT int __QAIC_HEADER(audio_pd_cdsp_deinit)(remote_handle64 _h) __QAIC_HEADER_ATTRIBUTE;
#ifndef audio_pd_cdsp_URI
#define audio_pd_cdsp_URI "file:///libaudio_pd_cdsp_skel.so?audio_pd_cdsp_skel_handle_invoke&_modver=1.0"
#endif /*audio_pd_cdsp_URI*/
#ifdef __cplusplus
}
#endif
#endif //_CDSP_DYN_PD_H
